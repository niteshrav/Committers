...
| CNT-02 | Contact UI | Contact opened | Verify phone, one email line (comma-separated `hello@…, commitersudaipur@…` + combined `mailto:`), address, map embed | Contact links and map are visible and usable |
